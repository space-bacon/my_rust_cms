...
fn update_component_property(properties: &mut ComponentProperties, property_name: &str, value: &str) {
    match property_name {
        "hero_title" => properties.hero_title = Some(value.to_string()),
        "hero_subtitle" => properties.hero_subtitle = Some(value.to_string()),
        "hero_primary_button_text" => properties.hero_primary_button_text = Some(value.to_string()),
        "hero_primary_button_url" => properties.hero_primary_button_url = Some(value.to_string()),
        "hero_secondary_button_text" => properties.hero_secondary_button_text = Some(value.to_string()),
        "hero_secondary_button_url" => properties.hero_secondary_button_url = Some(value.to_string()),
        "hero_background_image" => properties.hero_background_image = Some(value.to_string()),
        "card_title" => properties.card_title = Some(value.to_string()),
        "card_description" => properties.card_description = Some(value.to_string()),
        "card_image" => properties.card_image = Some(value.to_string()),
        "card_link" => properties.card_link = Some(value.to_string()),
        "image_url" => properties.image_url = Some(value.to_string()),
        "image_alt" => properties.image_alt = Some(value.to_string()),
        "video_url" => properties.video_url = Some(value.to_string()),
        "video_poster" => properties.video_poster = Some(value.to_string()),
        "button_text" => properties.button_text = Some(value.to_string()),
        "button_url" => properties.button_url = Some(value.to_string()),
        "button_style" => properties.button_style = Some(value.to_string()),
        "form_action" => properties.form_action = Some(value.to_string()),
        "form_method" => properties.form_method = Some(value.to_string()),
        "spacer_height" => properties.spacer_height = Some(value.to_string()),
        "divider_style" => properties.divider_style = Some(value.to_string()),
        "gallery_images" => properties.gallery_images = Some(value.split(',').map(|s| s.trim().to_string()).collect()),
        "testimonial_text" => properties.testimonial_text = Some(value.to_string()),
        "testimonial_author" => properties.testimonial_author = Some(value.to_string()),
        "testimonial_role" => properties.testimonial_role = Some(value.to_string()),
        "cta_title" => properties.cta_title = Some(value.to_string()),
        "cta_description" => properties.cta_description = Some(value.to_string()),
        "cta_button_text" => properties.cta_button_text = Some(value.to_string()),
        "cta_button_url" => properties.cta_button_url = Some(value.to_string()),
        _ => {}
    }
}
