                            ...
                            <div class="plugin-header">
                                <div class="plugin-info">
                                    ...
                                    <p class="plugin-version">{"v"}{&plugin.version}</p>
                                                    ...
                                                    <div class={format!("plugin-status {}", if plugin.status == "active" { "active" } else { "inactive" })}>
                        {if plugin.status == "active" { "Active" } else { "Inactive" }}
                                </div>
                            </div>
                                ...
                                <button 
                                    ...
                                    onclick={Callback::from({
                                        ...
                                        move |_| {
                                            if web_sys::window()
                                                .unwrap()
                                                .confirm_with_message(&format!("Are you sure you want to delete the '{}' plugin? This action cannot be undone.", plugin_display_name))
                                                .unwrap_or(false)
                                            {
