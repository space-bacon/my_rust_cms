...
impl Plugin for AnalyticsPlugin {
    fn manifest(&self) -> PluginManifest {
        PluginManifest {
            ...
            author_email: Some("team@rustcms.dev".to_string()),
            homepage_url: Some("https://rustcms.dev/plugins/analytics".to_string()),
            repository_url: Some("https://github.com/rustcms/plugin-analytics".to_string()),
